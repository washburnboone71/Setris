...
def make_background():
    ...
    LINE_COLOR = (255, 255, 255) #color for the grid line
    SURFACE_COLOR = (150, 130, 60) #color of brownish surface
    
    background = pygame.Surface((WIDTH,HEIGHT))

    #fill entire background (0, 255, 0)
    ...
    # draw black square
    pygame.draw.rect(background,(0, 0, 0), MAIN_SCREEN_RECT, border_radius=25)
    pygame.draw.rect(background,(0, 0, 0), INDEX_SCREEN_RECT, border_radius=25)
    pygame.draw.rect(background,(0, 0, 0), TIME_SCREEN_RECT, border_radius=25)
    pygame.draw.rect(background,(0, 0, 0), LEVEL_SCREEN_RECT, border_radius=25)
    ...
    for x in range(MAIN_SCREEN_RECT.left, MAIN_SCREEN_RECT.right, GRID_SPACING):
        ...
        pygame.draw.line(background, LINE_COLOR, start_point, end_point, 1)
    ...
    pygame.draw.line(background, (SURFACE_COLOR), (15,15), (700, 15), 1)
    pygame.draw.line(background, (SURFACE_COLOR), (15,15), (15, 685), 1)
